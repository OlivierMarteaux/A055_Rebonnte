# 📱 Rebonnte - a drogs-pharmaceutics supply chain management app


## 🚀 About the Project

Rebonnte is an Android application dedicated to manage the supply chain for a drogs - pharmaceutics factory.  
...
It uses Firebase as autenthication Api.
