        ...
        checkUserState(
            onUserLogged = { user ->
                viewModelScope.launch(dataDispatcher) {
                    ...
                    val changeRecordTitle : String = when {
                        medicine.stock < sourceMedicine.stock -> "Medicine stock decreased"
                        medicine.stock > sourceMedicine.stock -> "Medicine stock increased"
                    ...
                    log.d("MedicineViewModel::updateMedicine: changeRecordTitle = $changeRecordTitle")
