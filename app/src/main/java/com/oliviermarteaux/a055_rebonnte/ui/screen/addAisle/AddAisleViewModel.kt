...
/**
 * This ViewModel manages data and interactions related to adding new aisles in the AddScreen.
 * It utilizes dependency injection to retrieve a AisleRepository instance for interacting with aisle data.
 */
@HiltViewModel
